...
Finalmente, se implemento un modelo a escala, donde se busco alcanzar la falla por licuefaccion, calibrar el modelo de diferencias finitas y comparar los resultados obtenidos. El objetivo de esta seccion es poder visualizar toda la teoria anteriormente expuesta, observando asi las lineas de flujo, caudal de infiltracion etc.
\section{Resultados}
