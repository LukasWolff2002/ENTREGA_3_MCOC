...
\usepackage[spanish, es-tabla]{babel}  % Ajusta el idioma del documento a español.
\usepackage{tabularx}  % Permite la creación de tablas con ancho ajustable.

\renewcommand{\theequation}{Ec.~\arabic{equation}}  % Cambia la numeración de las ecuaciones.
...
\thispagestyle{empty}
\mbox{} % Este comando crea un espacio en blanco
