...
Del Cuadro \ref{tab:Manuales1} se puede observar que los resultados de caudal infiltrado 
son bastante distintos en cada caso, lo que puede explicarse por errores manuales de aproximación en los cálculos.
Además, la variabilidad del método de calculo utilizado puede influir en los resultados obtenidos, eso puede explicar los caudales tan elevados.